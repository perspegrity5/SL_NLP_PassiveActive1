...
def pipeline(ip_file, result_file, debug_file, model_type, DEBUG_ABSTRACTION_HIERARCHY = False, WEIGHT_METRICS = True):
    df = main_voice_classifier(model_type, ip_file)
...
def main():
    ...
    ip_file, result_file, debug_file, model_type, DEBUG_ABSTRACTION_HIERARCHY, WEIGHT_METRICS = args.ip_file, args.result_file, args.debug_file, args.model_type, args.debug_abstraction_hierarchy, args.weighted_metrics
    pipeline(ip_file, result_file, debug_file, model_type, DEBUG_ABSTRACTION_HIERARCHY, WEIGHT_METRICS)
